        ...
        <div class="modal-content">
					...
					<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="serialnumber" placeholder="Enter serial number" required="true">
                                    ...
                                    <div class="form-group">
                            <label>Problem</label>
                            <input class="form-control" type="text" name="problem" placeholder="Enter item problem" required="true">
                        </div>
                                        <div class="form-group">
			...
			<?php 
				...
				if (isset ($_POST ['save'])){
					...
					$conn->query("INSERT INTO received_items(date,fullname,jobnumber,department,branch,item,model,serialnumber,problem,received_by)values('$date','$fullname','$jobnumber','$department','$branch','$item','$model','$serialnumber','$problem','$received_by')")or die(mysql_error());
				}						
			?>
