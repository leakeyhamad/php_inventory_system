        ...
        <div class="modal-content">
			...
			<?php 
				...
				if (isset ($_POST ['save'])){
					...
					$conn->query("INSERT INTO retrieved_items(date,fullname,jobnumber,department,branch,cpu,monitor,keyboard,mouse,received_by)values('$date','$fullname','$jobnumber','$department','$branch','$cpu','$monitor','$keyboard','$mouse','$received_by')")or die(mysql_error());
				}						
			?>
