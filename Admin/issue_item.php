        ...
        <div class="modal-content">
			...
			<?php 
				...
				if (isset ($_POST ['save'])){
					...
					$conn->query("INSERT INTO issued_items(date,fullname,jobnumber,item,model,serialnumber,issued_by)values('$date','$fullname','$jobnumber','$item','$model','$serialnumber','$issued_by')")or die(mysql_error());
				}						
			?>
